...
export default function DashboardClient({
  ...
  return (
    <div className="flex-1 bg-[#fff0d6] text-[#3d1f00] font-serif relative overflow-hidden">
      {/* Corner decorations */}
      <div className="absolute top-0 left-0 pointer-events-none opacity-70 w-24 h-24 z-10">
        <DesiDecoration type="corner" />
      </div>
      <div className="absolute top-0 right-0 pointer-events-none rotate-90 opacity-70 w-24 h-24 z-10">
        <DesiDecoration type="corner" />
      </div>
      <div className="absolute bottom-0 left-0 pointer-events-none -rotate-90 opacity-70 w-24 h-24 z-10">
        <DesiDecoration type="corner" />
      </div>
      <div className="absolute bottom-0 right-0 pointer-events-none rotate-180 opacity-70 w-24 h-24 z-10">
        <DesiDecoration type="corner" />
      </div>
        ...
        >
          <div className="text-center sm:text-left">
            ...
            <p className="text-[#804000] text-base mt-2">
              Here&apos;s a list of your group chats. Let&apos;s keep the
              conversation going!
            </p>
          </div>
          ...
          {groups.length > 0 ? (
            ...
            >
              <div className="relative">
                <DesiDecoration
                  type="border"
                  className="absolute -top-10 w-full opacity-70"
                />
                ...
                <DesiDecoration
                  type="border"
                  className="absolute -bottom-10 w-full transform rotate-180 opacity-70"
                />
              </div>
            </motion.div>
          )}
